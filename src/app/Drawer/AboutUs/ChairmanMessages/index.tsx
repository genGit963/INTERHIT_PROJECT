...
// ----------------- ChairmanMessage screen ---------------------
const ChairmanMessageScreen: React.FC<ChairmanMessageScreenProps> = ({
  navigation,
}) => {
  ...
  const getMessageData = async () => {
    ...
    if (messageData) {
      ...
      setChairmanMessage(messageData);
    }
  };
...
export default ChairmanMessageScreen;
