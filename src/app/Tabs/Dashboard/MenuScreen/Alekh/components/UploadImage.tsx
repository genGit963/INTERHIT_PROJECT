...
const UploadImage = () => {
    ...
    return (
        <View>
            <HeroButton btnText={imageName ? imageName : "Upload Image"} onPress={handleImageUpload} varient="outlined" />
            {imageUri && <Image source={{ uri: imageUri }} style={{ height: 50, width: 50 }} />}
        </View>
    )
}
